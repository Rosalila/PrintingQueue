...
class ThingsControllerTest < ActionController::TestCase
  ...
  test "should create thing" do
    assert_difference('Thing.count') do
      post :create, thing: { name: @thing.name, ready_for_pickup_amount: @thing.ready_for_pickup_amount }
    end
  ...
  test "should update thing" do
    patch :update, id: @thing, thing: { name: @thing.name, ready_for_pickup_amount: @thing.ready_for_pickup_amount }
    assert_redirected_to thing_path(assigns(:thing))
  end
